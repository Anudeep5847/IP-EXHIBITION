...
export function Hero({ projectCount }: HeroProps) {
  ...
  return (
    <section className="relative overflow-hidden border-b h-[90vh] flex items-end transition-all duration-500">
      {/* Background Image */}
      <div
      ...
      <div
        className={`absolute inset-0 transition-all duration-500 z-10 ${
          isDark
            ...
            : "bg-gradient-to-b from-transparent via-white/10 to-white/80"
        }`}
      />
      ...
      <div className="relative z-30 container mx-auto px-4 sm:px-6 lg:px-8 pb-16">
